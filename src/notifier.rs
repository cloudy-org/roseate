        ...
        match string_or_error {
            StringOrError::Error(error) => {
                match error {
                    ...
                    Error::FailedToConvertImageToPixels(actual_error, _) => actual_error.unwrap_or_default(),
                    Error::MonitorNotFound(actual_error) => actual_error.unwrap_or_default(),
                    Error::FailedToEncodeImage(actual_error, _) => actual_error.unwrap_or_default(),
                    Error::FailedToDecodeImage(actual_error, _) => actual_error.unwrap_or_default(),
