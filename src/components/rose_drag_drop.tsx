        ...
        <div className="select-none">
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-2/4 max-w-screen-sm">
                ...
                dark:bg-goldyDarky bg-rose-100 text-white text-center rounded-lg">
                    ...
                    <div className="bg-rose-500 dark:bg-transparent rounded-md inline-block p-1 m-2 w-fit">
                        <h3 className="text-white dark:text-red-400 font-extrabold px-2">Drag and Drop</h3>
                    </div>
                </div>
            </div>
        </div>
